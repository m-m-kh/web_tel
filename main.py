...
WebAppData, SentWebAppMessage, InlineKeyboardButton, InlineKeyboardMarkup)
...
def main() -> None:
    ...
    application = Application.builder().token("6231149096:AAGRM-wzJWtCfdKwnMMU7swckxlZFsUoKO4").build()
